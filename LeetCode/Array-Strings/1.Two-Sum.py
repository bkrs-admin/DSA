...
"I use a hash map to store numbers and their indices. "
"For each number, I check if the complement exists. "
"This solution is O(n) in time and O(n) in space, which is optimal for the Two Sum problem."